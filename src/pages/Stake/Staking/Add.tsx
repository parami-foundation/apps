			...
			<div className={styles.mining}>
				...
				<div className={styles.field}>
					...
					<div className={styles.inputAndButton}>
						...
						<Button
							...
							shape='round'
							onClick={() => {
								setNumber(BigIntToFloatString(ad3Balance?.free, 18));
				...
				<div className={styles.actionButtons}>
					<Button
						...
						loading={submitting}
						disabled={FloatStringToBigInt(number, 18) <= BigInt(0) || FloatStringToBigInt(number, 18) > BigInt(ad3Balance?.free) || tokenAmount[1] > BigInt(tokenBalance)}
						onClick={() => {
							setSubmitting(true);
							setSecModal(true);
						}}
